...
class PurchaseRepository {
    ...
    public static insertPurchase(cd_purchase_mercado_pago: number, status_id: string, user_id: number, purchase_billet_id?: number, purchase_credit_card_id?: number): Promise<Purchase> {
